---
title: Information Classification for Confluence
description: Classify Confluence pages with configurable security levels.
...
|                                                      |                                                                    |
| ---------------------------------------------------- | ------------------------------------------------------------------ |
| [Installation](Installation)                         | Install from the Marketplace and first-time setup                  |
| [Configuration](Configuration)                       | Global settings: levels, contacts, links, languages                |
